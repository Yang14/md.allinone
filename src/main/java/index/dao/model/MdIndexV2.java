...
public class MdIndexV2 {
    ...
    public MdIndexV2(long pCode, String fName, long fCode, List<Long> dCodeList) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MdIndexV2)) return false;

        MdIndexV2 mdIndex = (MdIndexV2) o;
